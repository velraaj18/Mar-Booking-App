...
const Perks = ({ value, onChange }) => {
  ...
  return (
    <div>
      <h2 className=" font-bold text-2xl mt-4">Perks</h2>
      <p className=" text-gray-600 text-sm">Features of the place</p>
      <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 my-2">
        <label className=" flex p-4 border border-gray-200 rounded-lg gap-2">
          <input
            type="checkbox"
            checked={value.includes("wi-fi")}
        ...
        <label className="flex p-4 border border-gray-200 rounded-lg gap-2">
          <input
            type="checkbox"
            onChange={handleCheckBox}
            checked={value.includes("entrance")}
            name="entrance"
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
